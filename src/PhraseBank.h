...
inline constexpr std::array<Phrase, 24> kMotivator {{
    ...
    {STR16("Ich weiss nicht, was du gemacht hast. Aber mach mehr davon."), STR16("I don't know what you did. Do more of it.")},
    ...
    {STR16("Das klingt gefaehrlich gut."), STR16("That sounds dangerously good.")},
    {STR16("Du hast gerade aus Versehen Geschmack bewiesen."), STR16("You accidentally demonstrated excellent taste.")},
    {STR16("Der Refrain weiss genau, was er tut."), STR16("That chorus knows exactly what it's doing.")},
    ...
    {STR16("Der Sound hat Rueckgrat."), STR16("That sound has a spine.")},
    {STR16("Das ist kein Glueck mehr. Das kannst du."), STR16("That's not luck anymore. You can actually do this.")},
...
inline constexpr std::array<Phrase, 24> kDemotivator {{
    ...
    {STR16("Der Drop kommt? Danke fuer die Warnung."), STR16("The drop is coming? Thanks for the warning.")},
    {STR16("Das Mastering koennen wir uns sparen. Das Verbrechen ist bereits passiert."), STR16("Skip the mastering. The crime has already happened.")},
    {STR16("Ich wuerde eine Pause machen. Dein Song hat sich eine verdient."), STR16("Take a break. Your song has earned one.")},
    ...
    {STR16("Der Hall ist gross. Die Idee eher nicht."), STR16("Huge reverb. Tiny idea.")},
    {STR16("Das Timing nennt man vermutlich kuenstlerische Freiheit."), STR16("I assume that timing is artistic freedom.")},
    {STR16("Der Refrain sucht noch nach seinem Zweck."), STR16("The chorus is still looking for a purpose.")},
    {STR16("Ich habe schlechteres gehoert. Heute aber noch nicht."), STR16("I've heard worse. Just not today.")},
    {STR16("Dieser Sound braucht keinen Kompressor. Er braucht Hilfe."), STR16("That sound doesn't need compression. It needs help.")},
    {STR16("Zumachen aendert den Mix auch nicht."), STR16("Closing the window won't fix the mix.")},
